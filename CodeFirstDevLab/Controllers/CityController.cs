...
namespace CodeFirstDevLab.Controllers
{
    public class CityController : Controller
    {
        ...
        {
            ViewBag.ProvinceId = new SelectList(db.Provinces, "ProvinceId", "ProvinceCode");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CityId,Name,Population,ProvinceId")] City city)
        {
            if (ModelState.IsValid)
            {
